...
global para
set para(gui_mode) "1"
set para(prj_dir) "O:/src/Avant_lib/sincos_linear/project"
...
if {[file normalize "O:/src/Avant_lib/sincos_linear/project/Avant/sincos_linear_Avant_synplify.tcl"] != [file normalize "./sincos_linear_Avant_synplify.tcl"]} {
  file copy -force "O:/src/Avant_lib/sincos_linear/project/Avant/sincos_linear_Avant_synplify.tcl" "./sincos_linear_Avant_synplify.tcl"
}
