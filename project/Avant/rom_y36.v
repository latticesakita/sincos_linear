...
// Netlist written on Fri Jan  2 07:59:34 2026
...
//
// Verilog Description of module rom_y36
// module wrapper written out since it is a black-box. 
//

//

module rom_y36 (rd_clk_i, rst_i, rd_en_i, rd_clk_en_i, rd_addr_i, 
            rd_data_o) /* synthesis ORIG_MODULE_NAME="rom_y36", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    input rd_clk_i;
    input rst_i;
    input rd_en_i;
    input rd_clk_en_i;
